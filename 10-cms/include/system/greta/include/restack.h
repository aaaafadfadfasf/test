...
#if _MSC_VER < 1600
	#define static_assert static_assert_old
#endif
...
template< bool f > struct static_assert_old;
template<>         struct static_assert_old<true> { static_assert_old() {} };
...
private:
    ...
    struct stack_node
    {
        ...
        union
        {
            statck_node_header  m_head;
            byte_t  m_align[ aligned_sizeof<statck_node_header>::no_rtti ];
        };
    ...
    {
        stack_node  m_node;
        byte_t      m_buf[ aligned_sizeof<statck_node_header>::no_rtti + StaticBlockSizeT ];
    } m_first_node;
...
public:
    ...
    ~hetero_stack() // throw()
    {
        ...
        detail::static_assert_old< detail::is_power_of_two<AlignmentT>::value > const align_test;
    ...
    inline void push( T const & t ) // throw(std::bad_alloc,...)
    {
        ...
        detail::static_assert_old<( AlignmentT >= detail::alignof<T>::value )> const align_test;
    ...
    {
        detail::static_assert_old< RuntimeTypeCheckT > const type_check;
