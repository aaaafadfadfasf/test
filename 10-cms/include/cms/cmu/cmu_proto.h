...
protected:
	...
	bool isCheckRecvSRRR;
	int  sRRRCheckTimeout;
...
public:
	...
	void SetIsCheckRecvSRRR(bool bVar)
	{
		isCheckRecvSRRR = bVar;
	}
	bool GetIsCheckRecvSRRR() const
	{
		return isCheckRecvSRRR;
	}

	void SetSRRRCheckTimeout(int nVar)
	{
		sRRRCheckTimeout = nVar;
	}
	int GetSRRRCheckTimeout() const
	{
		return sRRRCheckTimeout;
	}
