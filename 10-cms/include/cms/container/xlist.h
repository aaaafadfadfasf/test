...
public:
	...
	bool GetHead(T& rHeadData) const
	{
	...
	bool GetTail(T& rTailData) const
	{
	...
	bool Get(Iterator pPos, T& rData) const
	{
	...
	bool GetNext(Iterator& pPos, T& rData) const
	{
	...
	bool GetPrev(Iterator& pPos, T& rData) const
	{
