...
typedef enum
{
	...
	RMSSDK_RMS_UPDATE_DEADLINE_REQ,                   /*TRSComm_DevID*/
	RMS_RMSSDK_UPDATE_DEADLINE_RSP,                   /*TRSComm_DevID*/

    RMSSDK_RMS_DELETE_PU_BINDING_REQ,            /*TRSComm_DeletePuBinding*/
    RMS_RMSSDK_DELETE_PU_BINDING_RSP             /*TRSComm_DeletePuBinding*/
