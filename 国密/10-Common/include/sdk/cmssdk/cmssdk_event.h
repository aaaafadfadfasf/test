...
enum ECMS_SDK_EVENT
{
    ...
    //与CMU的交互消息（目前已经使用到27769，下一个可用的为27770）
	...
	CMS_UPDATE_PU_VKEKS_NTF_REQ           = 27764,          //消息体: CCmsUpdatePuVkeksNtfReq
	CMS_UPDATE_PU_VKEKS_NTF_RSP           = 27765,          //消息体: CCmsUpdatePuVkeksNtfRsp
	CMS_PU_SIGNATURE_CTRL_REQ			  = 27766,		    //消息体: CCmsPuSignatureCtrlReq
	CMS_PU_SIGNATURE_CTRL_RSP			  = 27767,		    //消息体: CCmsPuSignatureCtrlRsp
	CMS_PU_ENCRYPTION_CTRL_REQ			  = 27768,		    //消息体: CCmsPuEncryptionCtrlReq
	CMS_PU_ENCRYPTION_CTRL_RSP			  = 27769,		    //消息体: CCmsPuEncryptionCtrlRsp
