...
#define NETSNMP_CONFIGURE_OPTIONS " '--with-default-snmp-version=3' '--with-sys-contact=LOGIN@DOMAINNAME' '--with-sys-location=Unknown' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/net-snmp' '--with-out-security-modules=ksm tsm' '--disable-FEATURE' '--disable-deprecated' '--disable-snmptrapd-subagent' '--disable-embedded-perl' '--disable-perl-cc-checks' '--without-PACKAGE' '--without-rpm' '--disable-manuals' '--disable-scripts' '--with-out-transports=UDPIPv6 TCPIPv6 TCP Alias AAL5PVC IPX DTLSUDP TLSTCP SSH' '--with-out-mib-modules=ucd_snmp utilities disman/event disman/schedule mibII snmpv3mibs agent_mibs' '--with-mib-modules=if-mib ip-forward-mib'"
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:IP-FORWARD-MIB:SNMP-TARGET-MIB:HOST-RESOURCES-TYPES:SNMP-NOTIFICATION-MIB:SNMPv2-TM"
...
#define NETSNMP_SYS_CONTACT "LOGIN@DOMAINNAME"
...
#define NETSNMP_ENTERPRISE_OID			24389
#define NETSNMP_ENTERPRISE_MIB			1,3,6,1,4,1,24389
#define NETSNMP_ENTERPRISE_DOT_MIB		1.3.6.1.4.1.24389
#define NETSNMP_ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define NETSNMP_SYSTEM_MIB		1,3,6,1,4,1,24389,3,2,NETSNMP_OSTYPE
#define NETSNMP_SYSTEM_DOT_MIB		1.3.6.1.4.1.24389.3.2.NETSNMP_OSTYPE
#define NETSNMP_SYSTEM_DOT_MIB_LENGTH	10

/* The assigned enterprise number for notifications. */
#define NETSNMP_NOTIFICATION_MIB		1,3,6,1,4,1,24389,4
#define NETSNMP_NOTIFICATION_DOT_MIB		1.3.6.1.4.1.24389.4
...
/* this is the location of the net-snmp mib tree.  It shouldn't be
   changed, as the places it is used are expected to be constant
   values or are directly tied to the UCD-SNMP-MIB. */
#define NETSNMP_OID		24389
#define NETSNMP_MIB		1,3,6,1,4,1,24389
#define NETSNMP_DOT_MIB		1.3.6.1.4.1.24389
