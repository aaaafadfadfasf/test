...
#define ERR_LICENSE_GET_MODULE_NAME         (u16)34						//获取senselock模块名失败
#define ERR_LICENSE_SET_MODULE_NAME         (u16)35						//设置senselock模块名失败
#define ERR_LICENSE_GET_KEY_MD5             (u16)36						//获取senselock锁内MD5失败
#define ERR_LICENSE_GET_BUFF_MD5            (u16)37					//获取锁外MD5失败
#define ERR_LICENSE_COMPARE_MD5             (u16)38
