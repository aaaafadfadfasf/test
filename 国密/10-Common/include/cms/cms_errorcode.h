...
enum ECMS_ERRORCODE
{
	...
	//security错误码
	ERR_SECURITY_BEGIN                              =30001,           //security错误码开始
	ERR_SECURITY_DB_OPR_FAIL                        =30002,           //数据库操作失败
	ERR_SECURITY_DB_DATA_NOT_EXIST                  =30003,           //数据库数据不存在
	ERR_SECURITY_OPEN_CERTS_FAIL                    =30004,           //打开证书文件失败
	ERR_SECURITY_CERTS_IS_NULL                      =30005,           //证书内容为空
	ERR_SECURITY_PUID_IS_NULL                       =30006,           //PUID为空
	ERR_SECURITY_CRT_SIGN_FAIL                      =30007,           //证书存储错误码
	ERR_SECURITY_GET_CRT_EMPTY                    =30008,           //获取证书为空
    ERR_SECURITY_END                                =30500,           //security错误码结束

    //PUIGB错误码
    ERR_PUIGB_BEGIN                                 =30501,           //puigb错误码开始
    ERR_PUIGB_OSPSIP_POSTMSG_FAIL                   =30502,           //ospsip投递消息失败
    ERR_PUIGB_VKEK_QRY_FAIL                         =30503,           //vkek查询出错

    ERR_PUIGB_END                                   =31000,           //puigb模块错误码结束
