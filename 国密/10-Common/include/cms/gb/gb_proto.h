...
class CGBClientVkeyNtfReq : public  CGBNotify
{
public:
	CGBClientVkeyNtfReq()
	{
		CmdType = GBCMDTYPE_VKEK_NTF;
	}
private:
    string DeviceID;
    string VKEKTime;
...
public:
    ...
    void SetVKEKTime(const string& strVKEKTime)
    {
        VKEKTime = strVKEKTime;
    }
    const string& GetVKEKTime() const
    {
        return VKEKTime;
    }
    string& GetVKEKTime()
    ...
    void SetVKEKVersion(const string& strVKEKVersion)
    {
        VKEKVersion = strVKEKVersion;
    }
    const string& GetVKEKVersion() const
    {
        return VKEKVersion;
    }
    string& GetVKEKVersion()
    {
        return VKEKVersion;
    }
    void SetVKEKValue(const string& strVKEKValue)
    {
        VKEKValue = strVKEKValue;
    }
    const string& GetVKEKValue() const
    {
        return VKEKValue;
    }
    string& GetVKEKValue()
    ...
    void SetWID(const int nWID)
    {
        WID = nWID;
    }
    const int GetWID() const
    {
        return WID;
    }
    void SetSourceID(const string& strSourceID)
...
class CGbGetCertificateReq:public CGBQuery
{
public:
	CGbGetCertificateReq()
	{
		CmdType = GBCMDTYPE_GET_CERTIFICATE;
	}
private:
    TGbCertificate Certificate;
public:
    virtual void Clear();
    virtual const std::string ToXml()const;
    virtual void ToXmlWithoutClassNameNode(TiXmlNode& xmlNode)const;
    ...
    virtual bool FromXml(const TiXmlNode& xmlNode);
public:
    void SetCertificate(const TGbCertificate& tCertificate)
    {
        Certificate = tCertificate;
    }
    const TGbCertificate& GetCertificate() const
    {
        return Certificate;
    }
    TGbCertificate& GetCertificate()
    {
        return Certificate;
    }
};

class CGbGetCertificateRsp:public CGBResponse
{
public:
	CGbGetCertificateRsp()
	{
		CmdType = GBCMDTYPE_GET_CERTIFICATE;
	}
private:
...
public:
    ...
    virtual bool FromXml(const TiXmlNode& xmlNode);
public:
    void SetCertificate(const string& strCertificate)
    {
        Certificate = strCertificate;
    }
...
class CGbSignatrueCtrlReq:public CGBControl
{
public:
	CGbSignatrueCtrlReq()
	{
		CmdType = GBCMDTYPE_SIGNATURE_CONTROL;
	}
private:
    string ControlCmd; //Start：启用签名；Stop：停止签名
public:
    virtual void Clear();
    virtual const std::string ToXml()const;
    virtual void ToXmlWithoutClassNameNode(TiXmlNode& xmlNode)const;
    ...
    virtual bool FromXml(const TiXmlNode& xmlNode);
public:
    void SetControlCmd(const string& strControlCmd)
    {
        ControlCmd = strControlCmd;
    }
    const string& GetControlCmd() const
    {
        return ControlCmd;
    }
...
class CGbSignatrueCtrlRsp:public CGBResponse
{
public:
	CGbSignatrueCtrlRsp()
	{
...
class CGbEncryptionCtrlReq:public CGBControl
{
public:
	CGbEncryptionCtrlReq()
	{
		CmdType = GBCMDTYPE_ENCRYPTION_CONTROL;
	}
private:
    string ControlCmd; //Start：启用加密；Stop：停止加密
public:
    virtual void Clear();
    virtual const std::string ToXml()const;
    virtual void ToXmlWithoutClassNameNode(TiXmlNode& xmlNode)const;
...
class CGbEncryptionCtrlRsp:public CGBResponse
{
public:
	CGbEncryptionCtrlRsp()
	{
		CmdType = GBCMDTYPE_ENCRYPTION_CONTROL;
	}
public:
