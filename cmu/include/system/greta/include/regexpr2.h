...
//{
    ...
    //static static_assert_old<32==sizeof(backref_tag<char*>)> const check_backref_size;
//}
...
public:
    ...
    ) const
    {
        ...
        detail::static_assert_old< detail::is_convertible<OtherT,IterT>::value > const iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        // convertible to type IterT. Check the declaration of your rpattern object.
        detail::static_assert_old< detail::is_convertible<CharT*,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        detail::static_assert_old< detail::is_convertible<iter_type,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
    ...
    ) const
    {
        ...
        // convertible to type IterT. Check the declaration of your rpattern object.
        detail::static_assert_old< detail::is_convertible<Char1T*,IterT>::value > const iterator_types_are_not_convertible;
        ( void ) iterator_types_are_not_convertible;
